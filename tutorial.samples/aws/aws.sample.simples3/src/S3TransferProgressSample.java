 ...
 * (C:\\Users\\Society\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3TransferProgressSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (C:\\Users\\Society\\.aws\\credentials).
         *
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Society\\.aws\\credentials), and is in valid format.",
                    e);
        }
        ...
        bucketName = "shudson.bucket.dev.02"; //+ StringUtils.lowerCase(credentials.getAWSAccessKeyId());
